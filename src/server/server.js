...
app.get  ('/api/machine/:machineId/retry', controllers.machine.retry);
app.get  ('/api/machine/:machineId/restart', controllers.machine.restart);
app.get  ('/api/machine/:machineId/status', controllers.machine.status);
